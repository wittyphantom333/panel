...
{
    protected const DEFAULT_URL = 'https://github.com/wittyphantom333/panel/releases/%s/panel.tar.gz';

    protected $signature = 'p:upgrade
        {--user= : The user that PHP runs under. All files will be owned by this user.}
        {--group= : The group that PHP runs under. All files will be owned by this group.}
        {--url= : The specific archive to download.}
        {--release= : A specific Pteranodon version to download from GitHub. Leave blank to use latest.}
        {--skip-download : If set no archive will be downloaded.}';

    protected $description = 'Downloads a new archive for Pteranodon from GitHub and then executes the normal upgrade commands.';
    ...
    public function handle()
    {
        ...
        $this->newLine(2);
        $this->info('Panel has been successfully upgraded. Please ensure you also update any Wings instances: https://pteranodon.io/buddy/1.0/upgrading.html');
    }
